package Modelo;  // Paquete de Modelo

/**
 * Clase que representa una Asignatura mágica.
 * 
 * Esta clase define los atributos y métodos para trabajar con Asignaturas mágicas,
 * incluyendo nombre y código especial.
 */
